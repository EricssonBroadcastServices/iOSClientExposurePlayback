...
public protocol Playable {
    ...
    func prepareSource(environment: Environment, sessionToken: SessionToken, adsOptions:AdsOptions?, adobePrimetimeMediaToken: String?, materialProfile: String?, customAdParams: [String: Any]?, metadataIdentifiers: [String]?, deviceMake:String?, deviceModel: String?, callback: @escaping (ExposureSource?, ExposureError?) -> Void)
...
extension Playable {
    ...
    ///   - customAdParams: Custom Ad params
    ///   - callback: Closure called on request completion
    public func prepareSourceWithResponse(environment: Environment, sessionToken: SessionToken, adsOptions:AdsOptions? = nil, adobePrimetimeMediaToken: String? = nil , materialProfile: String? = nil, customAdParams: [String: Any]? = nil , metadataIdentifiers: [String]? = nil, deviceMake:String?, deviceModel: String?, callback: @escaping (ExposureSource?, ExposureError?, HTTPURLResponse?) -> Void) {
        prepareSource(environment: environment, sessionToken: sessionToken, adsOptions: adsOptions, adobePrimetimeMediaToken: adobePrimetimeMediaToken, materialProfile: materialProfile, customAdParams: customAdParams, metadataIdentifiers:metadataIdentifiers, deviceMake: deviceMake, deviceModel: deviceModel) { source, error in
