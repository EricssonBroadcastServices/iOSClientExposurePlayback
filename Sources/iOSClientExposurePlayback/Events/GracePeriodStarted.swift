...
extension Playback {
    ...
    /// This will only be used to pass as an internal event. Will not be pushed to analytics backend. 
    /// Grace period ( the time app is in the background ) started .
    internal struct GracePeriodStarted {
...
extension Playback.GracePeriodStarted: AnalyticsEvent {
    var eventType: String {
        return "Playback.GracePeriodStarted"
    }
