...
extension Playback {
    ...
    /// Grace period ( time the app was in background ) was ended.
    internal struct GracePeriodEnded {
...
extension Playback.GracePeriodEnded: AnalyticsEvent {
