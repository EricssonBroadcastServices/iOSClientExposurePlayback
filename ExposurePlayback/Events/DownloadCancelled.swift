...
extension Playback {
    internal struct DownloadCancelled {
...
extension Playback.DownloadCancelled: AssetIdentifier { }
extension Playback.DownloadCancelled: AnalyticsEvent {
    internal var eventType: String {
        return "Playback.DownloadCancelled"
    }
