...
extension Playback {
    internal struct DownloadCompleted {
...
extension Playback.DownloadCompleted: AssetIdentifier { }
extension Playback.DownloadCompleted: AnalyticsEvent {
    internal var eventType: String {
        return "Playback.DownloadCompleted"
    }
